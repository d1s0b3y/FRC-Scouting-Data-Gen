...
for team in teams:
    ...
    print(f"gathered stats for {team['name']}      {teams.index(team)+1} teams queried, {teamAmt-teams.index(team)-1} remaining",)

fieldnames=statsLst[0].keys()

with open('1teams.csv', 'a', newline='',encoding='utf-8') as file:
